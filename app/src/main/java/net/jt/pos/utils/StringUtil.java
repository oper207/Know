...
import net.jt.pos.sample.BuildConfig;
...
public class StringUtil {
	...
	/**
	 * byteArray to String 변환
	 * @param arrBytes
	 * @return
	 */
	public static String byteArrayToString(byte[] arrBytes) {  // 10101004930001POS230215203230215123721 생성하는 곳
		int arrLength = arrBytes.length;
